    ...
    translation: {
      ...
      home: {
        heroSection: {
          ...
          heroSection__text: 'בחירה בטוחה למי שמעריך יציבות ושקט נפשי. מעל 20 שנות ניסיון, אלפי לקוחות מרוצים ברחבי הארץ. פתרונות ביטוח מקיפים למשפחה, לעסק ולחיים — עם הקפדה על כל פרט והתחשבות מלאה בצרכים שלכם.<br> השאירו פרטים — ותנו למקצוענים לדאוג לכם.',
      ...
      modalForm: {
        title: 'קבלו ייעוץ',
        description: 'מלאו את הטופס והמומחה שלנו יצור איתכם קשר',
        placeholder__name: 'שמך',
        placeholder__phone: 'מספר הטלפון שלך',
        placeholder__city: 'העיר שלך',
        submit: 'שלח'
      },
      ...
      thankYouPage: {
        ...
        message: "קיבלנו את פרטיך וניצור איתך קשר בקרוב.",
        close: "סגור"
      },
    }
  },
    ...
    translation: {
      ...
      home: {
        heroSection: {
          ...
          heroSection__text: 'Надёжный выбор для тех, кто ценит уверенность. Более 20 лет опыта, тысячи клиентов по всей стране. Комплексные страховые решения для семьи, бизнеса и жизни — с вниманием к деталям и вашим интересам.<br>Оставьте заявку — доверяйте важное профессионалам.',

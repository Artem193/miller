...
import { LifeInsuranceOverview } from './components/pages/Blog/articles/LifeInsuranceOverview/LifeInsuranceOverview';
  ...
  return (
    <Router basename='/'>
      ...
      <Routes>
        ...
        <Route path='/LifeInsuranceOverview' element={<LifeInsuranceOverview />}/>
      </Routes>
    </Router>
  );
}

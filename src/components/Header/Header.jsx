    ...
    <div className='containerMob'>
      ...
      <header className={openMenu === 'menuMob' ? 'header header--openMenu' : 'header'}>
        <Link to='/' className='header__logo'>
          <img className='header__logo' src='header/logo.webp' alt={t('header.logo')}></img>
        </Link>
        <nav className='nav'>
          <ul className='nav__list'>
              ...
              >
                ...
                {openDropdown === 'services' && (
                  <ul className='nav__dropdown'>
                    ...
                    <li className='nav__item'>
                      <Link className="nav__link nav__link--dropdown" to='/RealizationOfRights'>{t('header.rightsRealization')}</Link>
                    </li>
                  </ul>
                )}
              </span>
            ...
            <li className='nav__item'>
              <Link className='nav__link' to='/CustomerSupport'>{t('header.helpCustomers')}</Link>
            </li>
            <li className='nav__item'>
              <span
                className='nav__link'
        ...
        <img
          ...
          src={openMenu === 'menuMob' ? 'header/crossMenu.svg' : 'header/burger-menu.svg'}
          alt={t('header.menu')}
